...
echo "  CORE TOOLS"
echo "------------------------------------------------------------"
echo "  Restore Profiles  - restore presets over Config/."
echo "  View Status       - show overview.log."
echo "  View Logs         - show latest session log."
echo "  Device Report     - full hardware/software dump."
echo "  Uninstall Dolphin - ERADICATES everything. No undo."
echo ""
