...
echo "============================================================"
echo ""
echo "  PROFILES - COMPATIBILITY"
echo "------------------------------------------------------------"
echo "  Accuracy first. Slower."
echo ""
echo "  LEVELS"
echo "   MIN      Overclock 1.50  SyncGPU ON   3x res"
echo "   -2       Overclock 1.40  SyncGPU ON   3x res"
echo "   -1       Overclock 1.25  SyncGPU ON   2x res"
echo "   standard Overclock 1.00  SyncGPU ON   1x res"
