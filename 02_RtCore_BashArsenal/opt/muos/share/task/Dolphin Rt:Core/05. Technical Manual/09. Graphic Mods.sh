...
echo "  Workflow:"
echo "   1. Enable Mods"
echo "   2. Generate Installers"
echo "   3. Run each installer"
echo "   4. List All Mods"
echo ""
echo "  Enable Mods   - EnableGraphicsMods = True."
echo "  Disable Mods  - EnableGraphicsMods = False."
echo "  Generate      - one .sh per mod in Installers/."
echo "  List All Mods - [X] installed / [ ] not installed."
echo "  Clear All     - wipes Load/GraphicMods + installers."
echo ""
