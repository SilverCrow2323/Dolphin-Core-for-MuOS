...
echo "============================================================"
echo ""
echo "  PROFILES - RINTROMPING"
echo "------------------------------------------------------------"
echo "  Speed first. Aggressive."
echo ""
echo "  LEVELS"
echo "   MIN      Overclock 1.10  SyncGPU ON   2x res"
echo "   -2       Overclock 1.00  SyncGPU ON   1x res"
echo "   -1       Overclock 0.90  SyncGPU OFF  1x res"
echo "   standard Overclock 0.80  SyncGPU OFF  1x res"
echo "   +1       Overclock 0.70  SyncGPU OFF  1x res"
echo "   +2       Overclock 0.65  SyncGPU OFF  1x res"
echo "   MAX      Overclock 0.60  SyncGPU OFF  1x res"
echo ""
echo "  SIDE EFFECTS: missing tails/shadows/fog, audio crackle."
echo ""
