#!/bin/sh
# HELP: Diagnostic report of device and Dolphin setup
# ICON: diagnostic
#
# ============================================================
...
# ============================================================
#
#  Collects environment info useful for bug reports:
#    - muOS version, kernel, board
#    - CPU governor, RAM, swap
#    - Dolphin binary version
#    - Active profile and scouter value
#    - Installed Graphic Mods
#    - gptokeyb2 availability
