#!/bin/sh
# HELP: Remove the entire Dolphin Rt:Core installation
# ICON: junk
#
# ============================================================
...
# ============================================================
#
#  Deletes /opt/muos/share/emulator/dolphin/ recursively.
#
#  Removes:
#    dolphin binary
#    Config/            (all profiles and toggles)
#    rtdata/            (logs, presets, workshop, mods)
#    GameSettings/
#    GC/ and Wii/       (memory cards, NAND, saves)
#
#  NOT reversible.
