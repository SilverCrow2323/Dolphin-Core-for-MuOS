#!/bin/sh
# HELP: Remove every installed Graphics Mod. And it may help you to reunite with your sensei... MAYBE. Or maybe not.
# ICON: junk
#
# ============================================================
...
# ============================================================
#
#  - Tool 003 : CLEAR ALL MODS
#    Wipes Load/GraphicMods/ entirely.
#    Wipes Graphic Mods/Installers/ entirely.
#    Recreates RUNGIF (Chapter Two) in Installers/.
#
#    Sources in rtdata/graphic_mods/ are preserved.
#
#    Yes, I know. He comes back. He always comes back.
#
