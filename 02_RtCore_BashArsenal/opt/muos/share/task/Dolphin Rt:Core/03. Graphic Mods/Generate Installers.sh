#!/bin/sh
# HELP: Generate Installers | Funzionalità: Genera uno script per ogni mod | Descrizione: Scansiona rtdata/graphic_mods/ e crea un .sh per mod in Installers/. Rimuove RUNGIF. | ON: Installer generati | OFF (Default): Installer assenti | Risorse: Nessuna | Downside: Nessuno | MINORU's Quick Lesson #001: Se non lo lanci, RUNGIF continuerà a prenderti in giro.
# ICON: theme
#
# ============================================================
...
# ============================================================
#
#  - Tool : Generate Installers
#    Generate Installers | Funzionalità: Genera uno script per ogni mod | Descrizione: Scansiona rtdata/graphic_mods/ e crea un .sh per mod in Installers/. Rimuove RUNGIF. | ON: Installer generati | OFF (Default): Installer assenti | Risorse: Nessuna | Downside: Nessuno | MINORU's Quick Lesson #001: Se non lo lanci, RUNGIF continuerà a prenderti in giro.
#
